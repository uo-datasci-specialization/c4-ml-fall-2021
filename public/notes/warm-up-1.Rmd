...
```{r,fig.height= 6, fig.width=6,fig.align='center',warning=FALSE,class.source='klippy'}
...
```{r, error = TRUE, collapse=TRUE,class.source='klippy'}
...
```{r, collapse = TRUE,class.source='klippy'}
...
```{r, error = TRUE,class.source='klippy'}
